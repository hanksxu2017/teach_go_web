...
<div class="row">
    <div class="col-sm-5">
        <div class="content-body">
            <grid:grid id="selectedCourseGridId" url="${adminPath}/sys/course/ajaxList?teacherId=${teacher.id}"
                       multiselect="false">
                ...
                <grid:column label="sys.course.weekInfo" name="weekDay" dict="weekinfo" query="true"
                             queryMode="select"/>
    ...
    <div class="col-sm-2">
        <div class="text-center" style="padding-top: 200px;">
            <button class="btn btn-large btn-info" onclick="removeCourse()"><i class="fa fa-search"></i>移除</button>
            <br/>
